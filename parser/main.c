...
void test_parser_feed() {
    ...
    // Real life test-case: Safari
    {
        char *req_str =
            ...
            "*;q=0.8\r\n"
            "Cookie: "
            "__utma=96992031.1037738645.1429089370.1456747257.1457013590.3; "
            "__utmz=96992031.1456747257.2.1.utmcsr=(direct)|utmccn=(direct)|"
            "utmcmd=(none); __zlcmid=UGeZzV9tNTB3oY; "
            "csrftoken=MszhuwDmnu3fcWooBlotV7bfst347MnU; "
            "newsletter_popup_dismissed=1\r\n"
            "User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) "
            "AppleWebKit/601.4.4 (KHTML, like Gecko) Version/9.0.3 "
            "Safari/601.4.4\r\n"
        ...
        assert(h);
        assert(strcmp(h->name, "Accept") == 0);
        assert(strcmp(h->value, "text/html,application/xhtml+xml,application/"
                                "xml;q=0.9,*/*;q=0.8") == 0);
        ...
        assert(
            strcmp(
                h->value,
                "__utma=96992031.1037738645.1429089370.1456747257.1457013590.3;"
                " __utmz=96992031.1456747257.2.1.utmcsr=(direct)|utmccn=("
                "direct)|utmcmd=(none); __zlcmid=UGeZzV9tNTB3oY; "
                "csrftoken=MszhuwDmnu3fcWooBlotV7bfst347MnU; "
                "newsletter_popup_dismissed=1") == 0);
